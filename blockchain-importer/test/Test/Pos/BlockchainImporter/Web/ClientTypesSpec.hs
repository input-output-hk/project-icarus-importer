...
module Test.Pos.BlockchainImporter.Web.ClientTypesSpec
       ( spec
       ) where
...
import           Pos.Crypto
import           Pos.BlockchainImporter.Web.ClientTypes (CAddress (..), decodeHashHex, encodeHashHex,
...
-- stack test cardano-sl-blockchain-importer --fast --test-arguments "-m Test.Pos.BlockchainImporter.Web"
spec :: Spec
