-- | Tests of Pos.BlockchainImporter.Socket.Methods

{-# LANGUAGE AllowAmbiguousTypes #-}

module Test.Pos.BlockchainImporter.Socket.MethodsSpec
       ( spec
       ) where
...
import           Pos.BlockchainImporter.BlockchainImporterMode (runSubTestMode)
import           Pos.BlockchainImporter.Socket.Holder (ConnectionsState, BlockchainImporterSocket(..),
...
import           Pos.BlockchainImporter.Socket.Methods (addrSubParam, addressSetByTxs,
...
import           Pos.BlockchainImporter.Web.ClientTypes (CAddress (..), toCAddress)

import           Test.Pos.BlockchainImporter.MockFactory (mkTxOut)
...
mkSubConnectionState socketId =
    let ctx = mkClientContext $ TestSocket "blockchainImporter-test-socket" in
