...
module Pos.BlockchainImporter.Socket.App
       ( NotifierSettings (..)
       , notifierApp
       , toConfig
       ) where
...
import           Pos.BlockchainImporter.Socket.Holder (ConnectionsState, ConnectionsVar, askingConnState,
                                             mkConnectionsState, withConnState)
import           Pos.BlockchainImporter.Socket.Methods (ClientEvent (..), ServerEvent (..), Subscription (..),
...
import           Pos.BlockchainImporter.Socket.Util (emitJSON, on, on_, regroupBySnd, runPeriodically)
import           Pos.BlockchainImporter.Web.ClientTypes (cteId, tiToTxEntry)
import           Pos.BlockchainImporter.Web.Server (getMempoolTxs)
