module Pos.PostgresConsistency.Tables.PendingTxsTable
  ( -- * Data manipulation
    insertPendingTx
  , deletePendingTx
  , clearPendingTx
...
import           Pos.PostgresConsistency.Tables.TxAddrTable (TxAddrRowPGR, TxAddrRowPGW,
                                                             transactionAddrTable)
import qualified Pos.PostgresConsistency.Tables.TxAddrTable as TAT (insertTxAddresses)
import           Pos.PostgresConsistency.Tables.Utils
