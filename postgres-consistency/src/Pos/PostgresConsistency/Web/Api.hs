...
-- | Type-level specification of PostgresConsistency API (via Servant).

module Pos.PostgresConsistency.Web.Api
...
-- which allows to catch exceptions thrown by PostgresConsistency's endpoints.
