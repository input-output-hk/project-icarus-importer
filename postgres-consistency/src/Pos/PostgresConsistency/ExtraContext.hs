-- Classes and datatypes for managing extra context in PostgresConsistency.

{-# LANGUAGE RankNTypes #-}

module Pos.PostgresConsistency.ExtraContext
    ( ExtraContext (..)
    , ExtraContextT
    , runExtraContextT
    , makeExtraCtx
    ...
    , makeMockExtraCtx
    -- * PostgresConsistency mock interface
...
-- | This is what we use in production when we run PostgresConsistency.
...
-------------------------------------------------------------------------------------
-- PostgresConsistency interface instance
-------------------------------------------------------------------------------------
