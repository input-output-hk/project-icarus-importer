...
projects="networking binary util crypto core db lrc infra ssc txp update delegation block lib node client generator auxx tools explorer blockchain-importer postgres-consistency wallet wallet-new"
...
if [[ $spec_prj == "" ]]; then
  ...
  to_build="cardano-sl-node cardano-sl-postgres-consistency"
